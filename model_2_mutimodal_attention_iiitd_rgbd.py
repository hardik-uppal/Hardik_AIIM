...
#    (x_train, y_train), (x_test, y_test) = data
    ...
    # callbacks
    args.save_dir = args.save_dir + str(fold)
...
#        
        ...
        generator_rgb_val = train_datagen.flow_from_directory(directory="D:/RGB_D_Dataset_new/fold{}/train/RGB/".format(fold), target_size=(224, 224), color_mode="rgb",
                                                      batch_size=batch_size, class_mode="categorical", shuffle=True,subset='validation', seed=42)
        generator_depth_val = train_datagen.flow_from_directory(directory="D:/RGB_D_Dataset_new/fold{}/train/depth/".format(fold), target_size=(224, 224), color_mode="rgb",
                                                      batch_size=batch_size, class_mode="categorical", shuffle=True,subset='validation', seed=42)
        if val_train=='train':
            while 1:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./IIITD_RGBD_new/result_multimodal_attention_fold')
...
#            test(model=model_trained,fold = 2, args=args)
