...
#    x = layers.Input(shape=input_shape)
    ...
    pre_trained_model = RESNET50(include_top=False, weights='vggface', input_tensor=None, input_shape=None, pooling=None, classes=52)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./curtinFacres/result_resnet_rgb_1')
