...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./IIITD_RGBD_new/DATAAUG_multimodal_attention_bn_fold5_dropout-0.5_2fc')
...
#        os.makedirs(args.save_dir)
    ...
    batch_size_list = [20,30,10,40,50]
...
#                               test(model=trained_model,save_dir = save_dirc, args=args)
                               ...
                               reset_keras(model=trained_model)
