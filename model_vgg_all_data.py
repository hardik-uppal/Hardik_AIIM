...
#    x = layers.Conv2D(256, (3, 3), activation='relu', padding='same', name='conv3_3d')(x)
    ...
    # Block 4
    x = layers.Conv2D(256, (3, 3), activation='relu', padding='same', name='conv4_1d')(x)
...
#            yield [x_batch_depth, y_batch_depth]
    ...
    train_generator = train_datagen.flow_from_directory("D:/RGB_D_Dataset_all_data/train/depth/",target_size=(224, 224), color_mode="rgb",
                                                        batch_size=args.batch_size, class_mode='categorical',subset='training')
    
    validation_generator = train_datagen.flow_from_directory("D:/RGB_D_Dataset_all_data/train/depth/",target_size=(224, 224), color_mode="rgb",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./all_data/result_custom_depth_alldata_2')
...
#    (x_train, y_train), (x_test, y_test) = load_mnist()
    ...
    # define model
    model = VGGnet(input_shape=(224,224,3), n_class=72)
    model.summary()
#    weights_path = os.path.join(args.save_dir,'')
#    model.load_weights()
