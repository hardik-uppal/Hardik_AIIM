...
#        
    ...
    model.fit_generator(generator=train_generator(args.batch_size,'train'),
                        ...
                        validation_steps = int( 2028 / int(args.batch_size/5)),##4108 curtin faces###4181 fold1 iiitd
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./CurtinFaces/dataaug_vgg_multimodal_dropout-0.5_2fc-1024')
