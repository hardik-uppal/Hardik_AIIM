...
#    
    ...
    pre_trained_model = RESNET50(include_top=False, weights='vggface', input_tensor=None, input_shape=None, pooling=None,type_name='depth')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./CurtinFaces/dataaug_multimodal_att_resnet')
