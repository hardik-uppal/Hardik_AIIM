...
#    fc6 = layers.Dense(2048, activation='relu', name='fc6')(merge_rgb_depth)
    fc7 = layers.Dense(2048, activation='relu', name='fc7')(dropout_1)
...
#    train_model.load_weights(weights_path)
    ...
    train_model.summary()
    for layer in train_model.layers[:-7]:
        layer.trainable = False
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./IIITD_RGBD_new/w/oattention_withoutimgaug-0.5_2fc')
