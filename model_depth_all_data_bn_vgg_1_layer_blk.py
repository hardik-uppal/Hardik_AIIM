...
#    
    ...
    vgg_model_depth = VGG16_BN(input_tensor=None, input_shape=input_shape, conv_dropout=0.1, activation='relu')
...
#    fc6 = layers.Dense(2048, activation='relu', name='fc6')(merge_rgb_depth)
    ...
    train_model = models.Model(inputs= [inputs_depth], outputs=[output])
...
#                                                      batch_size=batch_size, class_mode="categorical", shuffle=True, seed=42)
        generator_depth = train_datagen.flow_from_directory(directory="D:/RGB_D_Dataset_all_data/train/depth/", target_size=(100, 100), color_mode="grayscale",
...
#                                                      batch_size=batch_size, class_mode="categorical", shuffle=True, seed=42)
        generator_depth_val = train_datagen.flow_from_directory(directory="D:/RGB_D_Dataset_all_data/train/depth/", target_size=(100, 100), color_mode="grayscale",
...
#                x_batch_rgb, y_batch_rgb = generator_rgb_val.next()
    ...
    model.fit_generator(generator=train_generator(args.batch_size,'train'),
                        steps_per_epoch=int(120107 / args.batch_size),##936 curtin faces###424 fold1 iiitd
                        epochs=args.epochs,
                        validation_data=train_generator(args.batch_size,'val'),
                        validation_steps = int( 13290 / args.batch_size),##4108 curtin faces###4181 fold1 iiitd
...
#        generator_rgb = train_datagen.flow_from_directory(directory="D:/CurtinFaces_crop/RGB/test2/", target_size=(100, 100), color_mode="rgb",
#                                                      batch_size=1, class_mode="categorical", shuffle=True, seed=42)
#        generator_depth = train_datagen.flow_from_directory(directory="D:/CurtinFaces_crop/normalized/DEPTH/test2/", target_size=(100, 100), color_mode="rgb",
#                                                      batch_size=1, class_mode="categorical", shuffle=True, seed=42)
#
#        while 1:
#            x_batch_rgb, y_batch_rgb = generator_rgb.next()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./allData/vgg_1layerblk_pandora_100-100')
    ...
    # define model
    model = VGGFace_multimodal(input_shape=(100,100,1), n_class=20)
    model.summary()
