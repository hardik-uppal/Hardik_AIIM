...
#    (x_train, y_train), (x_test, y_test) = data
    ...
    es_cb = callbacks.EarlyStopping(monitor='loss', patience=10, verbose=1, mode='auto')
    tb = callbacks.TensorBoard(log_dir=args.save_dir + '/tensorboard-logs',
                               batch_size=args.batch_size, histogram_freq=int(args.debug))
    checkpoint = callbacks.ModelCheckpoint(args.save_dir + '/weights-{epoch:02d}.h5', monitor='acc',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./CurtinFaces/multimodal_att_new_protocol_1')
