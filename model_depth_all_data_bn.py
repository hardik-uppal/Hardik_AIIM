...
#                                                      batch_size=batch_size, class_mode="categorical", shuffle=True, seed=42)
        generator_depth = train_datagen.flow_from_directory(directory="D:/RGB_D_Dataset_all_data/train/depth/", target_size=(224, 224), color_mode="rgb",
...
#                                                      batch_size=batch_size, class_mode="categorical", shuffle=True, seed=42)
        generator_depth_val = train_datagen.flow_from_directory(directory="D:/RGB_D_Dataset_all_data/train/depth/", target_size=(224, 224), color_mode="rgb",
...
#              
#              metrics=['accuracy'])
#    model.load_weights('./allData/vgg_allData_depth_bn/weights-16.h5')
#    
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='./allData/vgg_allData_depth_bn')
    ...
    # define model
    model = VGGFace_multimodal(input_shape=(224,224,3), n_class=72)
    model.summary()
